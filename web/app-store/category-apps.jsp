<%-- 
    Document   : category-apps
    Created on : Dec 7, 2011, 5:54:45 PM
    Author     : bitlooter
--%>
...
<%
    ...
    java.util.List<com.feezixlabs.bean.Widget> widgets = categoryId.compareTo("0") ==0? com.feezixlabs.db.dao.WidgetDAO.getAllDeployedApplets():com.feezixlabs.db.dao.WidgetDAO.getMenuWidgets(categoryId);
