...
org.activemq.Amq = function() {
  ...
  var clientId = null;
	...
	var messageHandler = function(data) {
                if(typeof(data.getElementsByTagName) != "function") return;
	...
	var sendPoll = function() {
		...
		var successCallback = sessionInitialized ? pollHandler : initHandler;
                //$('#debug-output').css({display:'block'}).append('<span style="background-color:black;color:yellow">debug:<span style="color:#04fd33">polling...</span></span><br/>');
